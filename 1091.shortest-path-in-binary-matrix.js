...
var shortestPathBinaryMatrix = function (grid)
{
    ...
    {
        const [forwardX, forwardY, forwardStep] = pushNextSteps(forwardQueue, forwardVisited, grid);
        ...
        const [backwardX, backwardY, backwardStep] = pushNextSteps(backwardQueue, backwardVisited, grid);
