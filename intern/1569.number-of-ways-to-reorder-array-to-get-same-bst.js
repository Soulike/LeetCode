...
function dfs(nums) {
  ...
  if (smallerCount === 0n) {
    ...
    for (let i = 0n; i <= smallerCount - 1n; i++) {
      ...
      rearrangeCount +=
        combination(smallerCount - 1n, i) *
        combination(largerCount + 1n, i + 1n);
    }
  }
...
console.log(
  numOfWays([
    10, 23, 12, 18, 4, 29, 2, 8, 41, 31, 25, 21, 14, 35, 26, 5, 19, 43, 22, 37,
    9, 20, 44, 28, 1, 39, 30, 38, 36, 6, 13, 16, 27, 17, 34, 7, 15, 3, 11, 24,
    42, 33, 40, 32,
  ]),
);
