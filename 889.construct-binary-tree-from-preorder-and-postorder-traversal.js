...
var constructFromPrePost = function (preorder, postorder)
{
    ...
    function helper(preorderLeft, preorderRight, postorderLeft, postorderRight)
    {
        ...
        for (let i = 1; i < LENGTH; i++)
        {
            ...
            {
                const leftTree = helper(preorderLeft + 1, preorderLeft + i + 1, postorderLeft, postorderLeft + i);
                const rightTree = helper(preorderLeft + i + 1, preorderRight, postorderLeft + i, postorderRight - 1);
                root.left = leftTree;
