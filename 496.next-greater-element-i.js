...
const nextGreaterElement = function (nums1, nums2)
{
    ...
    for (let i = 0; i < nums2.length; i++)
    {
        ...
        {
            let topIndex = monostackOfElementIndexInNums2[monostackOfElementIndexInNums2.length - 1];
            ...
            while (topTemp < nums2[i])   // 遇到了一个上升的温度
            {
                ...
                topIndex = monostackOfElementIndexInNums2[monostackOfElementIndexInNums2.length - 1];
