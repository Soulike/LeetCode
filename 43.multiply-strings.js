...
const multiply = function (num1, num2) 
{
    ...
    {
        oneBitMultiplyResult = add(oneBitMultiplyResult,
            multiplyOneBitNumAndNBitNum(short.charAt(i), long).concat('0'.repeat(shortLength - i - 1)))
    }
...
function multiplyOneBitNumAndNBitNum(oneBitNum, nBitNum)
{
    ...
    for (let i = nBitNumLength - 1; i >= 0; i--)
    {
        ...
        multiplyResult = nBitNumCharCodeConverted * oneBitNumCharCodeConverted + carry;
